...
class DatasetsTable extends PureComponent {
  ...
  render() {
    ...
    const { showActions, application, showNewDatasetButton, showRelatedContent, linkToNewWidgetFromName } = this.props;

    return (
      <div className={styles["c-dataset-table"]}>
        <Spinner className="-light" isLoading={loading} />

        <TableFilters filtersChange={this.onFiltersChange} application={application} />
        ...
        <CustomTable
          ...
          actions={{
            ...
            list: [
              {
                name: "Edit",
                route: "/admin/data/datasets/edit",
                show: true,
                component: EditAction,
                componentProps: { route: "/admin/data" }
              },
