...
export const LIST_WIDGET_TEMPLATE = {
  ...
  widgetConfig: {
    ...
    listWidgetConfig: {
      ...
      query:
        "https://api.resourcewatch.org/v1/query/47dc1a1b-2c91-4d69-b04e-ea8c4561e2b5?sql=SELECT date as key , no_smoothing as value FROM cli_044_global_land_temperature ORDER BY no_smoothing desc LIMIT 5",
      format: "0.2s",
      bullets: false,
      numbers: true,
      ...
      parameters: [
        {
          key: "date",
          query:
            "https://api.resourcewatch.org/v1/query/47dc1a1b-2c91-4d69-b04e-ea8c4561e2b5?sql=SELECT date FROM cli_044_global_land_temperature ORDER BY no_smoothing desc LIMIT 1",
          outputFormat: "%B %d, %Y",
          inputFormat: "%Y-%m-%d",
          type: "date",
          style: {
        ...
        },
        {
          key: "value",
          query:
            "https://api.resourcewatch.org/v1/query/47dc1a1b-2c91-4d69-b04e-ea8c4561e2b5?sql=SELECT no_smoothing as value FROM cli_044_global_land_temperature ORDER BY no_smoothing desc LIMIT 1",
          format: ".^20",
          type: "number",
          style: {
            fontStyle: "italic",
