        ...
        {!error && (
          <CustomTable
            ...
            actions={{
              show: true,
              list: [
                { name: 'Edit', route: '/admin/data/widgets/edit', params: { dataset }, show: true, component: EditAction },
                { name: 'Remove', route: '/admin/data/widgets/remove', params: { }, component: DeleteAction }
              ]
            }}
            sort={{
              field: 'name',
