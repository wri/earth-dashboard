...
class Step1 extends PureComponent {
  ...
  render() {
    const { user, layerPreview, verifyLayerConfig, query, form, id } = this.props;
    ...
    return (
      <fieldset className="c-field-container">
        ...
        {layerPreview.errors && this.layerConfigStatus("Layer config not valid!", layerPreview.errors)}
