...
const DatePickerBtn = ({ currentDate }) => (
  <div className={styles["c-showing-data-for"]}>
    <button className={styles["c-showing-data-for__button"]} role="button">
      <span className={styles["c-showing-data-for__text"]}>Showing Data for: <span className={styles["c-showing-data-for__date"]}>{formatDate(currentDate)}</span></span>
