...
// constants
import { MONGABAY_NEWS_TYPE, GUARDIAN_NEWS_TYPE } from "./constants";
  ...
  return (
    <div className={styles["c-news-widget"]}>
      ...
      {item && type === MONGABAY_NEWS_TYPE && (
        <MongabayNews item={item} showDescription={showDescription} showThumbnail={showThumbnail} />
      )}
      {item && type === GUARDIAN_NEWS_TYPE && <GuardianNews item={item} />}
