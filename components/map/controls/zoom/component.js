  ...
  render() {
    ...
    return (
      <div className={componentClass}>
        <button type="button" className={zoomInClass} disabled={zoom === maxZoom} onClick={this.increaseZoom}>
          <Icon name="icon-plus" />
        </button>
        <button type="button" className={zoomOutClass} disabled={zoom === minZoom} onClick={this.decreaseZoom}>
