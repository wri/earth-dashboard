...
export const PACIFIC_GARBAGE_PATCH_SVG =
    <svg className={styles['pacific-garbage-patch']} viewBox="0 0 600 300">
        <g fill="none" fill-rule="evenodd" transform="translate(40 20)">
            <path fill="none" stroke="#F35600" stroke-width="10" stroke-dasharray="12 20" d="M 259 12.5 C 404.8658 12.5 523.5 58.3047 523.5 118 C 523.5 177.6953 404.8658 223.5 259 223.5 C 113.1342 223.5 -5.5 177.6953 -5.5 118 C -5.5 58.3047 113.1342 12.5 259 12.5 Z Z" />
            <g fill="none" fill-rule="evenodd" stroke="#174F59" transform="translate(-27 -27)">
                <circle cx="27" cy="27" r="27" fill="#FFF" fill-rule="nonzero" stroke-width="3" />
