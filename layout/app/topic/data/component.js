...
function LayoutTopicData(props) {
  ...
  const navigationDotsColor =
    headlineInView || changeAgentsInView
      ...
      <div className={styles["topic-data"]}>
        ...
        {!isEmbed && (
          <>
            ...
            <div className={styles["headline-section"]} ref={headlineRef}>
              <HeadlineSection topic={topic} />
            </div>
          </>
        )}
        {(!isEmbed || (isEmbed && embeddedSection === "scrolly-telling")) && (
          <div id="scrolly-telling" className={styles["scrolly-telling-container"]} ref={scrollyTellingRef}>
            {getScrollyTelling()}
          </div>
        )}
        {!isEmbed && (
        ...
        {(!isEmbed || (isEmbed && embeddedSection === "dive-into-the-data")) && (
          <div ref={diveIntoDataRef}>
            <DiveIntoTheDataSection topic={topic} topicData={topicData} widgets={widgets} />
          </div>
        )}
        {!isEmbed && (
          <>
            ...
            <div className={styles["credits-resources-section"]} ref={creditsRef}>
