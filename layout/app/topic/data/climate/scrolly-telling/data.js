...
export const getChartLineProjection = (animate, mobile) => {
    if (mobile) {
...
export const getChartLineHistorical = (animate, mobile) => {
    if (mobile) {
...
export const getChartLinePresent = (animate, mobile) => {
    if (mobile) {
...
export const getChartLineFuture = (animate, mobile) => {
    if (mobile) {
...
export const CHART_AXES_1_MOBILE =
    <svg width="362px" height="543px" viewBox="0 0 362 543">
        <title>2B27A221-67EE-44E7-9A92-4BA65BA01709</title>
        <g id="mobile" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Earth-HQ---mobile---Climate" transform="translate(-5.000000, -2598.000000)">
                <g id="chart" transform="translate(5.000000, 2598.000000)">
                    <text id="2100-copy-3" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="340" y="540">2100</tspan>
                    </text>
                    <text id="+0.0-°C-Copy-3" font-family="Barlow Condensed" font-size="14" fill="#38444F">
                        <tspan x="6.664" y="418">+0.0 °C </tspan>
                    </text>
                    ...
                    <text id="2000" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="42" y="540">2000</tspan>
                    </text>
                    <text id="2020" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="102" y="540">2020</tspan>
                    </text>
                    <text id="2040" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="162" y="540">2040</tspan>
                    </text>
                    <text id="2060" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="221" y="540">2060</tspan>
                    </text>
                    <text id="2080" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="281" y="540">2080</tspan>
                    </text>
                    <rect id="Rectangle-Copy-38" fill="#7C90A2" fill-rule="nonzero" x="51" y="515" width="300" height="1"></rect>
                    <rect id="Rectangle-Copy-39" fill="#7C90A2" fill-rule="nonzero" x="51" y="414" width="300" height="2"></rect>
                    <rect id="Rectangle-Copy-40" fill="#7C90A2" fill-rule="nonzero" x="51" y="313" width="300" height="1"></rect>
                    <rect id="Rectangle-Copy-41" fill="#7C90A2" fill-rule="nonzero" x="51" y="212" width="300" height="1"></rect>
                    <rect id="Rectangle-Copy-42" fill="#7C90A2" fill-rule="nonzero" x="51" y="111" width="300" height="1"></rect>
                    <rect id="Rectangle-Copy-43" fill="#7C90A2" fill-rule="nonzero" x="51" y="9" width="300" height="1"></rect>
                    <line x1="114.037822" y1="514.621817" x2="114.037822" y2="9.13948188" id="Path" stroke="#B7C2CC" fill-rule="nonzero"></line>
                    <text id="historical-data-copy" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="33" y="31">historical data</tspan>
                    </text>
                    <text id="projections-copy" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="127" y="31">projections</tspan>
                    </text>
                </g>
            </g>
        </g>
...
export const CHART_AXES_2_MOBILE =
    <svg width="361px" height="543px" viewBox="0 0 361 543">
        <title>F4ECF07C-4508-4B4E-92D1-506FA638DD2E</title>
        <g id="mobile" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Earth-HQ---mobile---Climate" transform="translate(-7.000000, -1983.000000)">
                <g id="chart-copy" transform="translate(7.000000, 1983.000000)">
                    <text id="+0.0-°C-Copy-4" font-family="Barlow Condensed" font-size="14" fill="#38444F">
                        <tspan x="6.664" y="418">+0.0 °C </tspan>
                    </text>
                    <text id="+1.0°C-Copy-4" font-family="Barlow Condensed" font-size="14" fill="#38444F">
                    ...
                    <text id="1850-copy-4" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="42" y="540">1850</tspan>
                    </text>
                    <text id="1900-copy-4" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="100" y="540">1900</tspan>
                    </text>
                    <text id="1950-copy-4" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="159" y="540">1950</tspan>
                    </text>
                    <text id="2000-copy-4" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="217" y="540">2000</tspan>
                    </text>
                    <text id="2050-copy-4" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="279" y="540">2050</tspan>
                    </text>
                    <text id="2100-copy-4" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="339" y="540">2100</tspan>
                    </text>
                    <rect id="Rectangle-Copy-44" fill="#7C90A2" fill-rule="nonzero" x="51" y="515" width="300" height="1"></rect>
                    <rect id="Rectangle-Copy-45" fill="#7C90A2" fill-rule="nonzero" x="51" y="414" width="300" height="2"></rect>
                    <rect id="Rectangle-Copy-46" fill="#7C90A2" fill-rule="nonzero" x="51" y="313" width="300" height="1"></rect>
                    <rect id="Rectangle-Copy-47" fill="#7C90A2" fill-rule="nonzero" x="51" y="212" width="300" height="1"></rect>
                    <rect id="Rectangle-Copy-48" fill="#7C90A2" fill-rule="nonzero" x="51" y="111" width="300" height="1"></rect>
                    <rect id="Rectangle-Copy-49" fill="#7C90A2" fill-rule="nonzero" x="51" y="9" width="300" height="1"></rect>
                    <line x1="257.037822" y1="514.621817" x2="257.037822" y2="9.13948188" id="Path" stroke="#B7C2CC" fill-rule="nonzero"></line>
                    <text id="historical-data-copy-2" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="176" y="31">historical data</tspan>
                    </text>
                    <text id="projections-copy-2" font-family="Barlow Condensed" font-size="14" fill="#7C90A2">
                        <tspan x="270" y="31">projections</tspan>
                    </text>
                </g>
            </g>
        </g>
...
export const CHART_AXES_3_MOBILE =
    <svg width="361px" height="543px" viewBox="0 0 361 543">
        <title>68C2191D-1F3A-4BF9-A8DC-41CDA8E6D9E7</title>
        <g id="mobile" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Earth-HQ---mobile---Climate" transform="translate(-7.000000, -1374.000000)">
                <g id="chart-copy-2" transform="translate(7.000000, 1374.000000)">
                    <text id="+0.0-°C-Copy-4" font-family="Barlow Condensed" font-size="14" fill="#38444F">
                        <tspan x="6.664" y="418">+0.0 °C </tspan>
                    </text>
                    <text id="+1.0°C-Copy-4" font-family="Barlow Condensed" font-size="14" fill="#38444F">
