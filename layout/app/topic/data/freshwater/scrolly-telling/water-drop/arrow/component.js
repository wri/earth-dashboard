...
function Arrow({ direction }) {
  ...
  const secondGroup = ["up-and-down", "up-and-down-low", "up-and-down-low-final"];
      ...
      {firstGroup.includes(direction) && (
        ...
        >
          <div className={styles["divider-container"]}>
            {direction === "down" && <span className={styles["withdrawals-text"]}>⭣ withdrawals</span>}
            <img className={styles["divider"]} src="/static/images/scrolly-telling/freshwater/divider.svg" />
            {direction === "up" && <span className={styles["supplies-text"]}>⭡ supplies</span>}
          </div>
        ...
        <div className={styles["arrow-up-and-down"]}>
          ...
          >
            <div className={styles.arrow}>
              <img
                className={styles["arrow-down-short"]}
                src="/static/images/scrolly-telling/freshwater/arrow-down-short.svg"
              />
              {direction === "up-and-down" && (
                <img
                  className={styles["arrow-up-short"]}
                  src="/static/images/scrolly-telling/freshwater/arrow-up-short.svg"
                />
              )}
            </div>
            <div className={styles["divider-container"]}>
              {direction === "up-and-down" && <span className={styles["supplies-text"]}>⭡ supplies</span>}
              <img className={styles["divider"]} src="/static/images/scrolly-telling/freshwater/divider.svg" />
