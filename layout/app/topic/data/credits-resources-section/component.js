...
function CreditsResourcesSection(props) {
  ...
  const getCreditsAndResourcesContent = mobile => (
    <>
      <div className={styles["credits-field"]}>
        <h6 className={styles["field-title"]}>AUTHORS</h6>
        <div
      ...
      <div className={styles["credits-field"]}>
        <h6 className={styles["field-title"]}>METHODOLOGY</h6>
        <div
          className={classnames({
            [styles["field-content"]]: true,
            [styles["-desktop"]]: !mobile,
  ...
  return (
    <div id="credits-and-resources" className={styles["c-credits-resources-section"]}>
      <MediaContextProvider>
        <Desktop>
          ...
          >
            <h2>
              Credits and <span style={{ color: topicColor }}>Resources</span>
            </h2>
            <div
              className={classnames({
            ...
            >
              ...
              >
                <h6 className={styles["field-title"]}>SHARE THIS PAGE</h6>
                <ShareBox
                  topic={topic}
        ...
        <Mobile>
          ...
          >
            ...
            >
              <h6 className={styles["field-title"]}>SHARE THIS PAGE</h6>
              <ShareBox topic={topic} url={isServer ? "" : window.location.href} showInput={false} showBorder={false} />
            </div>
          </div>
        </Mobile>
      </MediaContextProvider>
