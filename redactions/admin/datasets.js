...
export const getAllDatasets = createAsyncThunk("datasets/getAllDatasets", options => (dispatch, getState) => {
...
export const getDatasetsByTab = createAsyncThunk("datasets/getDatasetsByTab", tab => (dispatch, getState) => {
